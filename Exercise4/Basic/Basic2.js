...
class Camera3D {
    ...
    update() {
        ...
        // this.u = ?
        // this.v = ? 
        let negViewDir = vec3.create(); // this is the gaze direction
        ...
        this.w = negViewDir; // already normalized, already in the right direction
        this.u = vec3.create();
        this.v = vec3.create();
        ...
        /*this.u[0] = [t[1]*this.w[2] - t[2]*this.w[1]];
        this.u[1] = [t[2]*this.w[0] - t[0]*this.w[2]];
        this.u[2] = [t[0]*this.w[1] - t[1]*this.w[0]];
        this.u[0] = this.u[0]/vec3.distance([0,0], this.u);
        this.u[1] = this.u[1]/vec3.distance([0,0], this.u);
        this.u[2] = this.u[2]/vec3.distance([0,0], this.u);
*/
        ...
        this.v[0] = [this.w[1]*this.u[2] - this.w[2]*this.u[1]];
        this.v[1] = [this.w[2]*this.u[0] - this.w[0]*this.u[2]];
        this.v[2] = [this.w[0]*this.u[1] - this.w[1]*this.u[0]];
        ...
        let u_te = this.u[0]*this.eye[0] + this.u[1]*this.eye[1] + this.u[2]*this.eye[2];
        let w_te = this.w[0]*this.eye[0] + this.w[1]*this.eye[1] + this.w[2]*this.eye[2];
        let v_te = this.v[0]*this.eye[0] + this.v[1]*this.eye[1] + this.v[2]*this.eye[2];
        ...
        //mat4.invert(this.cameraMatrixInverse, M_v);
        this.projectionMatrix = mat4.create();
